        ...
        <div className={styles.container}>
            ...
            <div className={styles['webnovel-grid']}>
                {webnovels.map((webnovel, index) => (
                    <a href={`/webnovel/${webnovel.rank}`} className={styles['webnovel-card']} key={index}>
                        <span className={styles['webnovel-rank']}>{webnovel.rank}</span>
                        <h3 className={styles['webnovel-title']}>{webnovel.title}</h3>
                        <p className={styles['webnovel-author']}>{webnovel.author}</p>
                        <span className={styles['webnovel-rating']}>{webnovel.rating}</span>
                        <p className={styles['webnovel-description']}>{webnovel.description}</p>
                        <div className={styles['webnovel-stats']}>
